...
function App() {
  ...
  return (
    <div 
      className={`w-screen h-screen overflow-hidden relative bezier-app-background ${
        theme === 'dark' ? 'bg-gray-900' : 'bg-gray-50'
      }`}
    >
      ...
      <div className="absolute inset-0 pointer-events-none opacity-30">
        ...
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-cyan-500 rounded-full filter blur-3xl animate-pulse animate-delay-1s"></div>
      </div>
      ...
      <div className="relative z-10 w-full h-full">
        ...
        {/* Top Header Bar */}
        <div 
          className={`fixed top-4 left-1/2 transform -translate-x-1/2 flex items-center gap-3 px-6 py-3 rounded-2xl shadow-lg z-50 ${
        ...
        {/* Bottom Action Bar */}
        <div 
          className={`fixed bottom-6 left-1/2 transform -translate-x-1/2 flex gap-3 p-3 rounded-2xl shadow-2xl z-50 ${
            theme === 'dark' ? 'glass-dark' : 'glass-light'
          }`}
        >
          <button
